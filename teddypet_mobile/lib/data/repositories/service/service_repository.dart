...
abstract class ServiceRepository {
  ...
  Future<List<ServiceResponse>> getServices();
  ...
  Future<List<RoomResponse>> getRoomsByLayoutConfigId(int layoutConfigId);
  Future<List<RoomTypeResponse>> getRoomTypes(int serviceId);
  Future<List<int>> getBookedRoomIds(String checkIn, String checkOut);
}
