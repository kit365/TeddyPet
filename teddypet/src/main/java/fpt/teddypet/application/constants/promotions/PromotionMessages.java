...
public final class PromotionMessages {
    ...
    public static final String MESSAGE_PROMOTION_DEACTIVATED_SUCCESS = "Vô hiệu hóa khuyến mãi thành công.";
    ...
    public static final String MESSAGE_PROMOTION_CODE_ALREADY_EXISTS = "Mã khuyến mãi này đã được sử dụng.";
    ...
    public static final String MESSAGE_PROMOTION_USER_LIMIT_REACHED = "Bạn đã sử dụng hết lượt khuyến mãi này.";
    public static final String MESSAGE_PROMOTION_MIN_ORDER_NOT_MET = "Đơn hàng chưa đủ giá trị tối thiểu.";
