        ...
        <div className={actionRight ? "flex items-start gap-2" : ""}>
            <div className={actionRight ? "flex-1 min-w-0 relative" : "relative"}>
                <div className="flex flex-wrap items-start justify-between gap-x-[12px] gap-y-[6px] mb-[6px]">
                    <label className="text-[1.4rem] font-[600] text-[#181818]">{label}</label>
                    <span className="text-[1.25rem] font-[500] text-[#888] leading-[1.45] sm:text-right sm:max-w-[520px]">
                        {disclaimer}
                    </span>
                </div>
                <button
                ...
                >
                    ...
                    <span className="ml-3 text-[#999] text-[1.3rem] shrink-0">{isOpen ? "▲" : "▼"}</span>
                </button>
