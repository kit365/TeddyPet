            ...
            <div className="bg-[#FFF0F0] rounded-[20px]">
                <div className="app-container pt-[150px] 2xl:pt-[120px]">
                    <div className="bg-client-primary p-[50px] rounded-[30px] relative flex items-center gap-[20px]">
                        ...
                        <h2 className="w-[55%] 2xl:w-[50%] pr-[40px] text-white text-[3.5rem] font-secondary relative">
                        ...
                        <form className="flex-1">
                            <div className="flex items-center relative">
                                <input type="email" placeholder="Nhập Email của bạn tại đây" name="email" className="py-[16px] px-[32px] rounded-[35px] w-full text-client-text text-[1.4rem] bg-white border border-[#d7d7d7] outline-none" />
                                <button className="absolute right-0 top-[50%] translate-y-[-50%] rounded-r-[40px] px-[32px] py-[16px] bg-client-secondary hover:bg-[#FFF3E2] text-white hover:text-client-secondary text-[1.5rem] font-secondary transition-colors duration-[350ms] ease-in-out cursor-pointer">Đăng ký</button>
                            </div>
                ...
                <div className="app-container pb-[30px] flex gap-[20px] border-b border-[#1029371A]">
                    ...
                    <div className="flex-1 py-[30px] pl-[30px]">
                        <div className="pb-[30px] border-b border-[#1029371A]">
                            <h3 className="text-[2rem] font-secondary text-client-secondary mb-[20px]">Thông tin liên hệ</h3>
