...
export const ProductDesc = ({ description }: ProductDescProps) => {
    ...
    const productTabsData = [
        ...
        },
        {
            ...
            key: "additional_info",
            content: `
                <p style="margin-bottom: 1.5rem;"><strong>Thông Số Kỹ Thuật:</strong> Sản phẩm được chế tạo từ các vật liệu an toàn, không chứa chất gây hại, đảm bảo sức khỏe cho thú cưng của bạn. Quy trình sản xuất tuân thủ nghiêm ngặt các tiêu chuẩn chất lượng quốc tế.</p>
