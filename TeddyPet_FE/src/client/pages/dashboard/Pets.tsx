            ...
            <div className="space-y-12">
                <div className="flex justify-between items-center bg-white">
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 bg-indigo-600/90 text-white px-8 py-4 rounded-[1.2rem] font-black text-[1.2rem] uppercase tracking-widest hover:bg-slate-800 transition-all shadow-lg shadow-indigo-100"
                    >
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        {pets.map((pet) => (
                            <div
                                key={pet.id}
                                className="bg-white border border-slate-100 rounded-[3rem] p-10 flex gap-8 hover:border-indigo-100 hover:shadow-2xl hover:shadow-indigo-50/50 transition-all group relative ring-1 ring-slate-50"
                            >
                                <img
                                    src={getAvatar(pet)}
                                    alt={pet.name}
