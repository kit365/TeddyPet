...
export const AddressEditPage = () => {
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        if (!fullName.trim() || !phone.trim() || (!isManualMode && !address.trim())) {
    ...
    if (loading) {
        return (
            <DashboardLayout pageTitle="Chỉnh sửa địa chỉ" breadcrumbs={breadcrumbs}>
                <div className="min-h-[40vh] flex flex-col items-center justify-center gap-4">
                    <div className="w-12 h-12 border-4 border-slate-100 border-t-client-primary rounded-full animate-spin"></div>
            ...
            <div className="max-w-[56rem] space-y-4 animate-in fade-in duration-500">
                ...
                <div className="flex items-center justify-between gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 font-medium mt-1">Cập nhật thông tin nhận hàng của bạn</p>
                    </div>
                </div>
