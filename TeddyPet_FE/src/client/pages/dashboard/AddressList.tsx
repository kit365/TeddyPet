    ...
    const addresses = [
        {
            id: 1,
            fullName: "Jhon Deo",
            phone: "+123 324 5879 39",
            address: "37 West 24th Street, New York 10010, United States",
            isDefault: true
        },
        {
            id: 2,
            fullName: "Jhon Deo",
            phone: "+123 324 5879 39",
            address: "441, 4th street, Washington DC, USA",
            isDefault: false
        },
        {
            id: 3,
        ...
        },
        {
            ...
            fullName: "Jhon Deo",
            phone: "+123 324 5879 39",
            address: "789, Broadway, Manhattan, NY, USA",
            isDefault: false
        }
    ];
                                        ...
                                        <div className="flex gap-[20px]">
                                            ...
                                            <div className="flex-1 space-y-[15px]">
                                                ...
                                                <div className="pt-[10px] flex items-center gap-[15px] opacity-0 group-hover:opacity-100 transition-opacity">
                                                    ...
                                                    <button
                                                        onClick={() => alert("Chức năng xóa sẽ được cập nhật sau!")}
