                            ...
                            <div className="p-[20px]">
                                <Link to={`/blog/detail/${blog.slug}`} className="block relative rounded-[20px] overflow-hidden aspect-[1520/800]">
                                    <img
                                        ...
                                        alt={blog.title}
                                    />
                                    <div className="date-blog absolute z-[20] top-[5%] left-[2%] bg-client-primary transition-default py-[10px] px-[16px] text-[1.8rem] leading-[1.2] text-white w-[65px] font-secondary text-center group-hover:bg-[#F7F3EB] group-hover:text-client-secondary">
                                ...
                                <div className="mt-[15px]">
                                    <div className="mt-[53px]">
                                        <div className="w-[7rem] h-[7rem] pt-[10px] pl-[10px] relative rounded-tl-[30px] bg-white cart-button">
                                            <Link to={`/blog/detail/${blog.slug}`} className="w-[6rem] h-[6rem] rounded-full bg-client-primary text-white flex items-center justify-center duration-[375ms] ease-[cubic-bezier(0.7,0,0.3,1)] group-hover:bg-client-secondary">
