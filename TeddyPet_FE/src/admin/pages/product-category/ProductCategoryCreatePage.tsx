import { Box, Stack, TextField, ThemeProvider, useTheme, Button, FormControl, InputLabel, Select, MenuItem, Checkbox, ListItemText, OutlinedInput, FormHelperText, Typography } from "@mui/material"
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Box sx={{
                        ...
                        <Button
                            type="button"
                            variant="outlined"
                            onClick={() => navigate(`/${prefixAdmin}/product-category/list`)}
                            sx={{
                                minHeight: '2.75rem',
                                minWidth: '6rem',
                                fontWeight: 700,
