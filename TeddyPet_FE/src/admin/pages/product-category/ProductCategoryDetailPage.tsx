...
import { useProductCategoryDetail, useUpdateProductCategory } from "./hooks/useProductCategory";
...
export const ProductCategoryDetailPage = () => {
    ...
    const { data: detailRes, isLoading, refetch } = useProductCategoryDetail(id);
    ...
    return (
        <Container disableGutters maxWidth={false} sx={{ px: "40px", pb: 5 }}>
            ...
            <Box sx={{ mb: 3 }}>
                <Button
                    component={Link}
                    to={`/${prefixAdmin}/product-category/list`}
                    color="inherit"
            ...
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 3 }}>
                <Box sx={{ display: "flex", gap: 1 }}>
                    <Tooltip title="Chỉnh sửa">
                        <IconButton onClick={() => navigate(`/${prefixAdmin}/product-category/edit/${category.categoryId}`)}>
