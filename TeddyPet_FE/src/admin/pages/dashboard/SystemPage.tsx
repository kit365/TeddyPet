                        ...
                        <Box sx={{ flexGrow: 1 }}>
                            ...
                            <Stack direction="row" alignItems="center" spacing={0.5} sx={{ color: 'var(--palette-text-disabled)' }}>
                                ...
                                <Typography variant="caption">
                                    ...
                                    ({customer.orderCount > 0 ? `${customer.orderCount} đơn` : ''}
                                    {customer.orderCount > 0 && customer.bookingCount > 0 ? ' & ' : ''}
                                    {customer.bookingCount > 0 ? `${customer.bookingCount} lịch` : ''})
                                </Typography>
                            </Stack>
                        </Box>
                        <Box sx={{
...
const SystemStats = ({ stats, chartData, ratingSummary }: { stats?: DashboardStatsResponse; chartData?: RevenueChartItem[]; ratingSummary?: RatingSummaryResponse }) => {
    ...
    return (
        <Stack spacing={5} sx={{ width: '100%', mb: 5 }}>
            {/* Section 1: Business */}
            <Box>
                <Typography variant="h6" sx={{ mb: 3, display: 'flex', alignItems: 'center', gap: 1, color: '#0062ff', fontWeight: 700 }}>
            ...
            {/* Section 2: Customers */}
            <Box>
                <Typography variant="h6" sx={{ mb: 3, display: 'flex', alignItems: 'center', gap: 1, color: 'text.primary', fontWeight: 700 }}>
                ...
                <Grid container spacing={3}>
                    <Grid size={{ xs: 12, md: 4 }}>
                        <SummaryWidget
                            ...
                            percent={8.5}
                            color="#0062ff"
                            chartData={[40, 45, 42, 50, 48, 55, 52, 60]}
                ...
                <Grid container spacing={3}>
                    <Grid size={{ xs: 12, md: 4 }}>
                        <SummaryWidget
                            ...
                            percent={12.5}
                            color="#0062ff"
                            chartData={[15, 22, 18, 25, 23, 30, 28, 35]}
                    ...
                    <Grid size={{ xs: 12, md: 4 }}>
                        <SummaryWidget
                            ...
                            percent={10.2}
                            color="#118d57"
                            chartData={[10, 15, 12, 18, 16, 22, 20, 25]}
                            to={`/${prefixAdmin}/booking/list`}
                        />
                    </Grid>
                    <Grid size={{ xs: 12, md: 4 }}>
...
export const SystemPage = () => {
    ...
    const topCustomers = ((): Array<{ name: string; totalSpent: number; orderCount: number; bookingCount: number; avatarUrl?: string }> => {
        const d = payload(topCustomersRes?.data as unknown as ApiResponse<any[]>);
