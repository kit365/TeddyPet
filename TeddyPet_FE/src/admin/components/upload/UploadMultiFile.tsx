...
export const UploadMultiFile = memo(
    ({ value = [], onChange, disabled, error, title = 'Hình ảnh' }: UploadMultiFileProps) => {
        ...
        return (
            <Stack>
                ...
                <div
                    {...getRootProps()}
                    className={`min-h-[220px] border border-[#919eab33] bg-[#919eab14] flex items-center justify-center cursor-pointer relative outline-none overflow-hidden p-[24px] rounded-[8px] hover:opacity-[0.72] transition-opacity duration-300 ease-linear ${
