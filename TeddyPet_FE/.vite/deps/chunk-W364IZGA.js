...
} from "./chunk-KNRJOA7Q.js";
import {
  warnOnce
} from "./chunk-BYEPIDUC.js";
import {
  ListItem_default,
  major,
  useMediaQuery_default,
  visuallyHidden_default
} from "./chunk-U2PC3A2R.js";
import {
  DialogActions_default
} from "./chunk-UXFCBEUI.js";
import {
  DialogContent_default
} from "./chunk-YJZVYJOS.js";
import {
  Chip_default
} from "./chunk-ECVNBY5W.js";
import {
  Popper_default
} from "./chunk-R43M4GML.js";
import {
  IconButton_default
} from "./chunk-5HA7EJJE.js";
import {
  useThemeProps
} from "./chunk-IU3YVSO2.js";
import {
  FormHelperText_default,
  TextField_default
} from "./chunk-U57L4HQO.js";
import {
  FormControl_default
} from "./chunk-26UIH73N.js";
import {
  InputLabel_default
} from "./chunk-ZMAAKYAU.js";
import {
  List_default
} from "./chunk-VF6SIIUZ.js";
import {
  useSlotProps_default
} from "./chunk-ORSSQEHF.js";
import {
  InputAdornment_default
} from "./chunk-SQUY5KS4.js";
import {
  useFormControl
} from "./chunk-OJ4XRLQL.js";
import {
  Dialog_default,
  dialogClasses_default
} from "./chunk-V6LDIMQD.js";
import {
  Button_default
} from "./chunk-TE2TFR33.js";
import {
  Grow_default
} from "./chunk-SOM4OANN.js";
import {
  Fade_default,
  FocusTrap_default
} from "./chunk-Q63SYYM4.js";
import {
  Paper_default
} from "./chunk-FE2H6EW7.js";
import {
  useControlled
} from "./chunk-RUDPENBW.js";
import {
  ownerDocument
...
import {
  Typography_default
} from "./chunk-S6BUF6PD.js";
import {
  ButtonBase_default
} from "./chunk-6QDSDGMJ.js";
import {
...
import {
  refType_default,
  useTimeout
} from "./chunk-RAREGJT6.js";
import {
  CSSTransition_default,
  TransitionGroup_default
} from "./chunk-AF567TVE.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-AVUONKA5.js";
import {
  useEventCallback_default
} from "./chunk-ZPXOJW34.js";
import {
  useForkRef
} from "./chunk-ULULFR2E.js";
import {
  useTheme
} from "./chunk-LOMQA27W.js";
import {
  alpha,
  capitalize,
  composeClasses,
...
var usePickerLayout = (props) => {
  ...
  const ownerState = React23.useMemo(() => _extends({}, pickerOwnerState, {
...
var PickersLayout = React24.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime9.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime9.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime9.jsxs)(React24.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime9.jsxs)(React24.Fragment, {
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React26.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
function PickersFadeTransitionGroup(inProps) {
  ...
  return (0, import_jsx_runtime11.jsx)(PickersFadeTransitionGroupRoot, {
    className: clsx_default(classes.root, className),
    ownerState: other,
    children: (0, import_jsx_runtime11.jsx)(Fade_default, {
      appear: false,
      mountOnEnter: true,
      unmountOnExit: true,
      timeout: {
...
var useNow = (timezone) => {
  const adapter = usePickerAdapter();
  const now = React30.useRef(void 0);
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React32.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
  ...
  return (0, import_jsx_runtime14.jsx)(Day, _extends({}, dayProps, {
    day,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const {
    ...
    readOnly,
    reduceAnimations,
    renderLoading = () => (0, import_jsx_runtime14.jsx)("span", {
      children: "..."
    }),
    slideDirection,
    TransitionProps,
  ...
  const validSelectedDays = React32.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
  ...
  return (0, import_jsx_runtime14.jsxs)(PickersCalendarDayRoot, {
    role: "grid",
    "aria-labelledby": gridLabelId,
    className: classes.root,
    children: [(0, import_jsx_runtime14.jsxs)(PickersCalendarDayHeader, {
      role: "row",
      className: classes.header,
      children: [displayWeekNumber && (0, import_jsx_runtime14.jsx)(PickersCalendarWeekNumberLabel, {
        variant: "caption",
        role: "columnheader",
        "aria-label": translations.calendarWeekNumberHeaderLabel,
        className: classes.weekNumberLabel,
        children: translations.calendarWeekNumberHeaderText
      }), getWeekdays(adapter, now).map((weekday, i) => (0, import_jsx_runtime14.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
    ...
    }), loading ? (0, import_jsx_runtime14.jsx)(PickersCalendarLoadingContainer, {
      className: classes.loadingContainer,
      children: renderLoading()
    }) : (0, import_jsx_runtime14.jsx)(PickersCalendarSlideTransition, _extends({
      ...
      children: (0, import_jsx_runtime14.jsx)(PickersCalendarWeekContainer, {
        ref: slideNodeRef,
        role: "rowgroup",
        className: classes.monthContainer,
        children: weeksToDisplay.map((week, index) => (0, import_jsx_runtime14.jsxs)(PickersCalendarWeek, {
          role: "row",
          className: classes.weekContainer,
          "aria-rowindex": index + 1,
          children: [displayWeekNumber && (0, import_jsx_runtime14.jsx)(PickersCalendarWeekNumber, {
          ...
          }), week.map((day, dayIndex) => (0, import_jsx_runtime14.jsx)(WrappedDay, {
            parentProps: props,
            day,
...
var MonthCalendarButton = React33.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime15.jsx)(MonthButton, _extends({}, monthButtonProps));
});
...
var _excluded14 = ["autoFocus", "className", "currentMonth", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var MonthCalendar = React35.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React35.useMemo(() => adapter.getMonth(now), [adapter, now]);
  const selectedMonth = React35.useMemo(() => {
    if (value != null) {
      return adapter.getMonth(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedMonth, setFocusedMonth] = React35.useState(() => selectedMonth || adapter.getMonth(referenceDate));
  ...
  const isMonthDisabled = React35.useCallback((dateToValidate) => {
    const firstEnabledMonth = adapter.startOfMonth(disablePast && adapter.isAfter(now, minDate) ? now : minDate);
    const lastEnabledMonth = adapter.startOfMonth(disableFuture && adapter.isBefore(now, maxDate) ? now : maxDate);
  ...
  return (0, import_jsx_runtime16.jsx)(MonthCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: getMonthsInYear(adapter, currentMonth ?? value ?? referenceDate).map((month) => {
      ...
      return (0, import_jsx_runtime16.jsx)(MonthCalendarButton, {
        selected: isSelected,
        value: monthNumber,
...
true ? MonthCalendar.propTypes = {
  ...
  currentMonth: import_prop_types5.default.object,
  /**
...
var YearCalendarButton = React36.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime17.jsx)(YearButton, _extends({}, yearButtonProps));
});
...
var YearCalendar = React37.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React37.useMemo(() => adapter.getYear(now), [adapter, now]);
  const selectedYear = React37.useMemo(() => {
    if (value != null) {
      return adapter.getYear(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedYear, setFocusedYear] = React37.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React37.useCallback((dateToValidate) => {
  ...
  const scrollerRef = React37.useRef(null);
  ...
  return (0, import_jsx_runtime18.jsxs)(YearCalendarRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: [yearRange.map((year) => {
      ...
      return (0, import_jsx_runtime18.jsx)(YearCalendarButton, {
        selected: isSelected,
        value: yearNumber,
      ...
      length: fillerAmount
    }, (_, index) => (0, import_jsx_runtime18.jsx)(YearCalendarButtonFiller, {}, index))]
  }));
});
...
function useDateCalendarDefaultizedProps(props, name) {
  ...
  return _extends({}, themeProps, validationProps, {
    ...
    reduceAnimations,
    renderLoading: themeProps.renderLoading ?? (() => (0, import_jsx_runtime21.jsx)("span", {
      children: "..."
    }))
  });
}
...
var DateCalendar = React40.forwardRef(function DateCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsxs)(DateCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime21.jsx)(CalendarHeader, _extends({}, calendarHeaderProps, {
      slots,
      slotProps
    })), (0, import_jsx_runtime21.jsx)(DateCalendarViewTransitionContainer, {
      reduceAnimations,
      className: classes.viewTransitionContainer,
      transKey: view,
      ownerState,
      children: (0, import_jsx_runtime21.jsxs)("div", {
...
var renderDateViewCalendar = ({
  ...
  displayWeekNumber,
  timezone
}) => (0, import_jsx_runtime22.jsx)(DateCalendar, {
  view,
  onViewChange,
...
var useMobilePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime24.jsxs)(PickerProvider, _extends({}, providerProps, {
    children: [(0, import_jsx_runtime24.jsx)(Field, _extends({}, fieldProps, {
      slots: _extends({}, slots, fieldProps.slots),
      slotProps: _extends({}, slotProps, fieldProps.slotProps),
      inputRef
    })), (0, import_jsx_runtime24.jsx)(PickersModalDialog, {
      slots,
      slotProps,
      children: (0, import_jsx_runtime24.jsx)(Layout, _extends({}, slotProps?.layout, {
        slots,
        slotProps,
        children: renderCurrentView()
      }))
...
function useApplyDefaultValuesToDateTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React42.useMemo(() => internalProps.ampm ?? adapter.is12HourCycleInCurrentLocale(), [internalProps.ampm, adapter]);
  return React42.useMemo(() => _extends({}, internalProps, validationProps, {
...
var _excluded21 = ["slots", "slotProps", "elements", "sectionListRef", "classes"];
...
function PickersSection(props) {
  ...
  const sectionContentRef = React44.useRef(null);
  ...
  return (0, import_jsx_runtime25.jsxs)(Section, _extends({}, sectionProps, {
    children: [(0, import_jsx_runtime25.jsx)(SectionSeparator, _extends({}, sectionSeparatorBeforeProps)), (0, import_jsx_runtime25.jsx)(SectionContent, _extends({}, sectionContentProps, {
      ref: handleSectionContentRef,
      onBlur: handleContentBlur
    })), (0, import_jsx_runtime25.jsx)(SectionSeparator, _extends({}, sectionSeparatorAfterProps))]
  }));
}
...
var PickersSectionList = React44.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime25.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime25.jsx)(React44.Fragment, {
      children: elements.map((element, elementIndex) => (0, import_jsx_runtime25.jsx)(PickersSection, {
        slots,
        slotProps,
        element,
        classes
...
var PickerTextFieldOwnerStateContext = React45.createContext(null);
if (true) PickerTextFieldOwnerStateContext.displayName = "PickerTextFieldOwnerStateContext";
var usePickerTextFieldOwnerState = () => {
  const value = React45.useContext(PickerTextFieldOwnerStateContext);
  if (value == null) {
...
var _excluded28 = ["elements", "areAllSectionsEmpty", "defaultValue", "label", "value", "onChange", "id", "autoFocus", "endAdornment", "startAdornment", "renderSuffix", "slots", "slotProps", "contentEditable", "tabIndex", "onInput", "onPaste", "onKeyDown", "fullWidth", "name", "readOnly", "inputProps", "inputRef", "sectionListRef", "onFocus", "onBlur", "classes", "ownerState"];
...
var PickersInputBase = React46.forwardRef(function PickersInputBase2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInputBase"
  });
  ...
  const activeBarRef = React46.useRef(null);
  const sectionOffsetsRef = React46.useRef([]);
  const handleRootRef = useForkRef(ref, rootRef);
  ...
  return (0, import_jsx_runtime26.jsxs)(InputRoot, _extends({}, inputRootProps, {
    children: [startAdornment, (0, import_jsx_runtime26.jsx)(PickersSectionList, {
      sectionListRef,
      elements,
      contentEditable,
      tabIndex,
    ...
    }), endAdornment, renderSuffix ? renderSuffix(_extends({}, muiFormControl)) : null, (0, import_jsx_runtime26.jsx)(PickersInputBaseInput, _extends({
      name,
      ...
      ref: handleInputRef
    })), isSingleInputRange && (0, import_jsx_runtime26.jsx)(PickersInputBaseActiveBar, {
...
var _excluded29 = ["children", "className", "label", "notched", "shrink"];
...
function Outline(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(OutlineRoot, _extends({
    "aria-hidden": true,
    className
  }, other, {
    ownerState,
    children: (0, import_jsx_runtime27.jsx)(OutlineLegend, {
      ownerState,
      notched,
      children: label ? (0, import_jsx_runtime27.jsx)(OutlineLabel, {
        children: label
      }) : (
        // notranslate needed while Google Translate will not fix zero-width space issue
        (0, import_jsx_runtime27.jsx)(OutlineLabel, {
...
var _excluded30 = ["label", "autoFocus", "ownerState", "classes", "notched"];
...
var PickersOutlinedInput = React48.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersOutlinedInput"
  });
  ...
  return (0, import_jsx_runtime28.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime28.jsx)(Outline, {
      shrink: Boolean(notched || state.adornedStart || state.focused || state.filled),
      notched: Boolean(notched || state.adornedStart || state.focused || state.filled),
      className: classes.notchedOutline,
      label: label != null && label !== "" && muiFormControl?.required ? (0, import_jsx_runtime28.jsxs)(React48.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
var _excluded31 = ["label", "autoFocus", "disableUnderline", "hiddenLabel", "classes"];
...
var PickersFilledInput = React49.forwardRef(function PickersFilledInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersFilledInput"
  });
...
var _excluded33 = ["label", "autoFocus", "disableUnderline", "ownerState", "classes"];
...
var PickersInput = React50.forwardRef(function PickersInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInput"
  });
...
var PickersTextField = React51.forwardRef(function PickersTextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersTextField"
  });
  ...
  const ownerState = React51.useMemo(() => _extends({}, fieldOwnerState, {
  ...
  return (0, import_jsx_runtime31.jsx)(PickerTextFieldOwnerStateContext.Provider, {
    value: ownerState,
    children: (0, import_jsx_runtime31.jsxs)(PickersTextFieldRoot, _extends({
      className: clsx_default(classes.root, className),
      ref: handleRootRef,
      focused,
      disabled,
      ...
      children: [label != null && label !== "" && (0, import_jsx_runtime31.jsx)(InputLabel_default, _extends({
        ...
        "data-active-range-position": dataActiveRangePosition
      }, inputAdditionalProps, InputProps)), helperText && (0, import_jsx_runtime31.jsx)(FormHelperText_default, _extends({
        id: helperTextId
      }, FormHelperTextProps, {
        children: helperText
      }))]
...
var _excluded35 = ["enableAccessibleFieldDOMStructure"];
var _excluded210 = ["InputProps", "readOnly", "onClear", "clearable", "clearButtonPosition", "openPickerButtonPosition", "openPickerAriaLabel"];
var _excluded36 = ["onPaste", "onKeyDown", "inputMode", "readOnly", "InputProps", "inputProps", "inputRef", "onClear", "clearable", "clearButtonPosition", "openPickerButtonPosition", "openPickerAriaLabel"];
...
var cleanFieldResponse = (_ref) => {
  let {
    enableAccessibleFieldDOMStructure
  } = _ref, fieldResponse = _objectWithoutPropertiesLoose(_ref, _excluded35);
  if (enableAccessibleFieldDOMStructure) {
    ...
    const mergedInputProps2 = major >= 6 && other2?.slotProps?.input ? mergeSlotProps(other2?.slotProps?.input, InputProps2) : noop2;
    return {
      clearable: clearable2,
      onClear: onClear2,
      clearButtonPosition: clearButtonPosition2,
  ...
  const {
    ...
    openPickerAriaLabel
  } = fieldResponse, other = _objectWithoutPropertiesLoose(fieldResponse, _excluded36);
  const mergedInputProps = major >= 6 && other?.slotProps?.input ? mergeSlotProps(other?.slotProps?.input, InputProps) : noop2;
  const mergedHtmlInputProps = major >= 6 && other?.slotProps?.htmlInput ? mergeSlotProps(other?.slotProps?.htmlInput, inputProps) : noop2;
  return {
    clearable,
    onClear,
    clearButtonPosition,
...
var PickerFieldUIContext = React52.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
...
function PickerFieldUI(props) {
  ...
  const pickerFieldUIContext = React52.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
  ...
  if (!textFieldInputProps?.startAdornment && (clearButtonPosition === "start" || openPickerButtonPosition === "start")) {
    additionalTextFieldInputProps.startAdornment = (0, import_jsx_runtime32.jsxs)(InputAdornment, _extends({}, startInputAdornmentProps, {
      children: [openPickerButtonPosition === "start" && (0, import_jsx_runtime32.jsx)(OpenPickerButton, _extends({}, openPickerButtonProps, {
        children: (0, import_jsx_runtime32.jsx)(OpenPickerIcon, _extends({}, openPickerIconProps))
      })), clearButtonPosition === "start" && (0, import_jsx_runtime32.jsx)(ClearButton, _extends({}, clearButtonProps, {
        children: (0, import_jsx_runtime32.jsx)(ClearIcon2, _extends({}, clearIconProps))
      }))]
    }));
  }
  if (!textFieldInputProps?.endAdornment && (clearButtonPosition === "end" || openPickerButtonPosition === "end")) {
    additionalTextFieldInputProps.endAdornment = (0, import_jsx_runtime32.jsxs)(InputAdornment, _extends({}, endInputAdornmentProps, {
      children: [clearButtonPosition === "end" && (0, import_jsx_runtime32.jsx)(ClearButton, _extends({}, clearButtonProps, {
        children: (0, import_jsx_runtime32.jsx)(ClearIcon2, _extends({}, clearIconProps))
      })), openPickerButtonPosition === "end" && (0, import_jsx_runtime32.jsx)(OpenPickerButton, _extends({}, openPickerButtonProps, {
        children: (0, import_jsx_runtime32.jsx)(OpenPickerIcon, _extends({}, openPickerIconProps))
      }))]
    }));
  }
  if (!additionalTextFieldInputProps?.endAdornment && !additionalTextFieldInputProps?.startAdornment && pickerFieldUIContext.slots.inputAdornment) {
    additionalTextFieldInputProps.endAdornment = (0, import_jsx_runtime32.jsx)(InputAdornment, _extends({}, endInputAdornmentProps));
  }
  ...
  return (0, import_jsx_runtime32.jsx)(TextField, _extends({}, textFieldProps, {
...
function PickerFieldUIContextProvider(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(PickerFieldUIContext.Provider, {
    value: contextValue,
    children
  });
}
...
var useFieldState = (parameters) => {
  ...
  const localizedDigits = React53.useMemo(() => getLocalizedDigits(adapter), [adapter]);
  const sectionsValueBoundaries = React53.useMemo(() => getSectionsBoundaries(adapter, localizedDigits, timezone), [adapter, localizedDigits, timezone]);
  ...
  const hasPartiallyFilledSectionsOnBlur = React53.useMemo(() => {
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React56.useCallback((sectionIndex) => (event) => {
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React57.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
...
//# sourceMappingURL=chunk-W364IZGA.js.map
