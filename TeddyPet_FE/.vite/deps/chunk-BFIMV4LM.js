...
var FormControlLabel = React5.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsxs)(FormControlLabelRoot, {
    ...
    ref,
    ...other,
    children: [React5.cloneElement(control, controlProps), required ? (0, import_jsx_runtime4.jsxs)("div", {
...
var Switch = React8.forwardRef(function Switch2(inProps, ref) {
  ...
  const icon = (0, import_jsx_runtime7.jsx)(ThumbSlot, {
    ...thumbSlotProps
  });
  ...
  return (0, import_jsx_runtime7.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [(0, import_jsx_runtime7.jsx)(SwitchSwitchBase, {
      type: "checkbox",
      icon,
      checkedIcon: icon,
      ref,
...
//# sourceMappingURL=chunk-BFIMV4LM.js.map
