...
public class OrderCleanupScheduler {
    ...
    /**
     * Tự động hủy các đơn hàng chuyển khoản (BANK_TRANSFER) đã quá 1 giờ mà chưa
     * thanh toán.
    ...
    public void cancelExpiredOrders() {
        ...
        log.debug("Checking for expired orders created before {}", expiryTime);
                ...
                try {
                    ...
                    if (!isPaid) {
                        orderService.cancelOrderByAdmin(
                                order.getId(),
                                "Hệ thống tự động hủy do quá 1 giờ chưa nhận được thanh toán chuyển khoản.",
                                "SYSTEM");
