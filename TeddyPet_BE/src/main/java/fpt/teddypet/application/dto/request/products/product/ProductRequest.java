...
public record ProductRequest(
        @NotBlank(message = "Tên sản phẩm là bắt buộc") @Size(max = 200, message = "Tên sản phẩm không được vượt quá 200 ký tự") String name,

        @Size(max = 50, message = "Mã vạch không được vượt quá 50 ký tự") String barcode,

        @Size(max = 50, message = "Slug không được vượt quá 50 ký tự") String slug,

        @Size(max = 5000, message = "Mô tả không được vượt quá 5000 ký tự") String description,

        @Size(max = 255, message = "Meta title không được vượt quá 255 ký tự") String metaTitle,

        @Size(max = 500, message = "Meta description không được vượt quá 500 ký tự") String metaDescription,

        BigDecimal minPrice,

        BigDecimal maxPrice,

        @Size(max = 100, message = "Xuất xứ không được vượt quá 100 ký tự") String origin,

        @Size(max = 100, message = "Chất liệu không được vượt quá 100 ký tự") String material,
        ...
        fpt.teddypet.domain.enums.ProductTypeEnum productType,
