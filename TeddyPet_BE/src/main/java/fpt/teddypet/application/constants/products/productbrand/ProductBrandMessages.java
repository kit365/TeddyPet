...
public final class ProductBrandMessages {
    ...
    public static final String MESSAGE_PRODUCT_BRANDS_SYNC_SUCCESS = "Đồng bộ thương hiệu sản phẩm thành công.";
    ...
    public static final String MESSAGE_PRODUCT_BRAND_NAME_ALREADY_EXISTS = "Tên thương hiệu sản phẩm đã tồn tại.";
