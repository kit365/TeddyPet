...
public final class RoomMessages {
    ...
    public static final String MESSAGE_ROOM_POSITION_OCCUPIED = "Vị trí (Block %s, Tầng %s, Hàng %d, Cột %d, Ngăn %s) đã có phòng khác. Không thể đặt hai phòng trùng vị trí.";
