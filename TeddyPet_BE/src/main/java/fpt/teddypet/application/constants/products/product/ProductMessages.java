...
public final class ProductMessages {
    ...
    public static final String MESSAGE_PRODUCT_NOT_ACTIVE = "Sản phẩm với ID: %d không hoạt động";
    ...
    public static final String MESSAGE_PRODUCT_CATEGORY_NOT_FOUND = "Không tìm thấy danh mục với ID: %s";
    public static final String MESSAGE_PRODUCT_BRAND_NOT_FOUND = "Không tìm thấy thương hiệu với ID: %s";
    public static final String MESSAGE_PRODUCT_TAG_NOT_FOUND = "Không tìm thấy thẻ với ID: %s";
    public static final String MESSAGE_PRODUCT_AGE_RANGE_NOT_FOUND = "Không tìm thấy độ tuổi với ID: %s";
}
